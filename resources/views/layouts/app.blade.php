...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="https://sistemaogj.com/public/favicons/favicon.ico">
        <!-- Fonts -->
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    @can('admin.home')
                        <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="https://docs.google.com/spreadsheets/d/1ruv2dVaV8ui7ENrdZvTVmoqdTqEG7nww/edit#gid=1303784504" target="_blank">Resultados Históricos 2014-2024</a>
                    ...
                    @can('admin.home')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-divider"></div>
                                <!-- <a class="dropdown-item" href="http://sistemaogj.com/admin" target="_blank">Resultados Parciales 2023</a> -->
                            </div>
                        </li>
                    @endcan
                    <li class="nav-item">
