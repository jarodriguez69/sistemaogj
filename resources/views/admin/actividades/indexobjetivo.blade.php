...
@section('content_header')
    ...
    <h1>Tareas - {{$objetivo->name}} ({{$objetivo->id}}) </h1>
@endsection
...
@endif
    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-striped" id="actividadesbyproject"> 
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
...
@section('js')
    <script>
        ...
        $('#actividadesbyproject').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "{{route('admin.actividades.gettaskbyproject')}}",
            "data": function ( d ) {
                d.objetivo = {{$objetivo->id}};
