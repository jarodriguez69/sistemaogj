        ...
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('admin.operativas.show', $operativa)}}" class="btn btn-sm btn-warning" title="Ver" target='_blank'><i class="fas fa-fw fa-eye"></i></a> 
                                <a href="{{route('admin.operativas.edit', $operativa->id)}}" class="btn btn-sm btn-info" title="Editar" target='_blank'><i class="fas fa-fw fa-edit"></i></a>  
                                ...
                                @endif 
                                <a href="{{route('admin.objetivos.indexoperativa', $operativa)}}" class="btn btn-sm btn-dark" title="Ver Objetivos" target='_blank'><i class="far fa-fw fa-circle text-cyan"></i></a>
