                        ...
                        <tbody>
                            @foreach ($tareasvencidas as $tareavencida)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.tareas.show', $tareavencida)}}" class="btn btn-sm btn-warning" title="Ver"><i class="fas fa-eye"></i></a> 
                                        <a href="{{route('admin.tareas.edit', $tareavencida->id)}}" class="btn btn-sm btn-info" title="Editar"><i class="fas fa-edit"></i></a>  
                                        <a href="{{route('admin.tareas.destroy', $tareavencida->id)}}" class="btn btn-sm btn-danger" title="Eliminar"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
$('#tareasvencidas').DataTable( {
    ...
    title: {
        text: 'Porcentaje<br>Tareas<br>Completadas',
        align: 'center',
...
Highcharts.chart('container4', {
    ...
    title: {
        text: 'Tareas Vencidas y No Vencidas'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
