...
class ProyectoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.proyectos.create', compact('grupos','users','equipos','partes'));
    }
    ...
    public function edit(Proyecto $proyecto)
    {
        ...
        $equipos = User::all();
        $partes = Parte::where('enabled',true)->get();
        return view('admin.proyectos.edit', compact("proyecto","grupos","estados","users","equipos","partes"));
    }
    ...
    public function getproject(Request $request)
    {
        if($request->ajax())
        {
            $proyectos = Proyecto::with('grupos', 'estadoproyecto', 'user')->select('id', 'name', 'grupo_id', 'begin', 'end', 'estadoproyecto_id', 'user_id')->get();
    ...
    public function getprojectbygroup(Request $request)
    {
        if($request->ajax())
        {
            $proyectos = Proyecto::with('estadoproyecto', 'user')->select('id', 'name', 'begin', 'end', 'estadoproyecto_id', 'user_id')->where('grupo_id', $request->grupo)->get();
            return Datatables::of($proyectos)
                    ->addColumn('actions',function($proyecto){
                        return view('admin.proyectos.action', compact('proyecto'));
                    })
