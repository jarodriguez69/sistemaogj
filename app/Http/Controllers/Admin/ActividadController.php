...
class ActividadController extends Controller
{
    ...
    public function gettaskbyproject(Request $request)
    {
        if($request->ajax())
        {
            $actividades = Actividad::with('objetivos', 'estadoactividad')->select('id', 'name', 'objetivo_id', 'begin', 'end', 'estadoactividad_id','porcentaje')->where('objetivo_id', $request->objetivo)->get();
    ...
    public function getactividad(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $actividades = Actividad::with('objetivos', 'estadoactividad')->select('id', 'name', 'objetivo_id', 'begin', 'end', 'estadoactividad_id','porcentaje')->get();
            return Datatables::of($actividades)
                    ->addColumn('actions',function($actividad){
                        return view('admin.actividades.action', compact('actividad'));
                    })
